...
END:VCARD`.trim()
        ...
        async value(jid, button, rows, quoted, options = {}) {
            ...
            return await conn.sendLists(jid, sections.title, listMessage.text, listMessage.footer, listMessage.buttonText, listMessage.sections, quoted, {
                    ...options
                })
          }
        },
        ...
        sendList: {
            async value(jid, title, text, footer, buttonText, buffer, listSections, quoted, options) {
                ...
                return await conn.sendLists(jid, title, text, footer, buttonText, sections, quoted, {
                    ...options
                })
            }
        },
            ...
            async value(jid, text = '', footer = '', buffer, buttons, quoted, options) {
                ...
                let message = {
                    ...
                    buttons: buttons.map(btn => ({
                        id: !nullish(btn[1]) && btn[1] || !nullish(btn[0]) && btn[0] || '',
                            display_text: !nullish(btn[0]) && btn[0] || !nullish(btn[1]) && btn[1] || ''
                    })),
                    ...(buffer ?
                ...
                return await conn.sendButtonMessages(jid, text, message.footer, buffer, message.buttons, [], null, null, quoted, {
                    ...options
                })
            },
            enumerable: true
