...
END:VCARD`.trim()
        ...
        async value(jid, button, rows, quoted, options = {}) {
            ...
            return await conn.sendLists(jid, sections.title, listMessage.text, listMessage.footer, listMessage.buttonText, listMessage.sections, quoted, ...options)
          }
        },
        /**
         * appenTextMessage
        ...
        sendList: {
            async value(jid, title, text, footer, buttonText, buffer, listSections, quoted, options) {
                ...
                return await conn.sendLists(jid, title, text, footer, buttonText, listSections, quoted, ...options)
            }
        },
        sendLists: {
